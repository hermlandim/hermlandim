# 💫 About Me:
Experiência Em Nodejs, React, Typescript, Context-API; <br>
Experiência Em Express, Postgresql, API Rest, Python, Django-Rest-Framework;
Conhecimento em Redux, React Query, MongoDB e Amazon AWS
